...
const mockData = {
  groups: [
    { uuid: "group1", name: "Group 1", users: ["developer@example.com"] },
  ],
  tasks: [
    { uuid: "task1", name: "Task 1", description: "Description 1", status: "open", assignedTo: "developer@example.com", assignedGroup: "group1" },
    { uuid: "task2", name: "Task 2", description: "Description 2", status: "closed", assignedTo: "manager@example.com" },
  ],
};
